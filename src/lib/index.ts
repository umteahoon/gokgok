...
export const recentFestivals: Festival[] = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1599930113854-d6d7fd521f10?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080",
    category: "역사문화",
    status: "upcoming",
  },
  {
...
export const getCategoryColor = (category: string): string => {
  const colorMap: Record<string, string> = {
    전통문화:
      "bg-[#F5E8D3] text-[#8C6239] dark:bg-[#4A3623] dark:text-[#E3C8A8]",
    체험: "bg-[#FFFBEB] text-[#B45309] dark:bg-[#451A03] dark:text-[#FCD34D]",
    겨울축제: "bg-blue-500/10 text-blue-600",
    불꽃축제:
      "bg-gradient-to-r from-[#FFE5E5] via-[#FFF0E0] to-[#FFF8E0] text-[#CC4444] border-none shadow-none font-medium",
