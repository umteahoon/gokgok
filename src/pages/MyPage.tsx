      ...
      >
        <Tabs defaultValue="saved" className="w-full">
          ...
          <TabsContent value="attended">
            <motion.div variants={staggerItem}>
              <h2 className="text-2xl font-bold mb-6">참여한 축제</h2>
              {attendedFestivals.length > 0 ? (
                        ...
                        <div className="flex gap-6">
                          ...
                          <div className="flex-1">
                            <div className="flex items-start justify-between mb-2">
                              ...
                              <Badge className={getStatusBadge(festival.status).className}>
                                {getStatusBadge(festival.status).label}
                              </Badge>
                            </div>
                            <p className="text-muted-foreground mb-2">{festival.location}</p>
                            <p className="text-sm text-muted-foreground mb-3">{festival.date}</p>
                ...
                <Card className="text-center py-12">
                  <CardContent>
                    ...
                    <p className="text-muted-foreground">아직 참여한 축제가 없습니다</p>
                  </CardContent>
                </Card>
              )}
            </motion.div>
              ...
              <div className="space-y-4 max-w-2xl">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>축제 알림을 관리할 수 있습니다</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="font-medium">새로운 축제 알림</p>
                        <p className="text-sm text-muted-foreground">새로운 축제가 등록되면 알림을 받습니다</p>
                      </div>
                      <input type="checkbox" defaultChecked className="w-5 h-5" />
                    </div>
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="font-medium">찜한 축제 시작 알림</p>
                        <p className="text-sm text-muted-foreground">찜한 축제가 시작되면 알림을 받습니다</p>
                      </div>
                      <input type="checkbox" defaultChecked className="w-5 h-5" />
                    </div>
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">이메일로 축제 정보를 받습니다</p>
                      </div>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>계정 설정을 관리할 수 있습니다</CardDescription>
                  </CardHeader>
